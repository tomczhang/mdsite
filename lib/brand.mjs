...
// 品牌主题色 + 报告徽标用的 M 标识（一笔 M，纯色 stroke 以便同页多处复用、无 id 冲突）。
const MDSITE_BRAND_COLOR = '#63fe13'
const MDSITE_LOGO_SVG = `<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="width:100%;height:100%;display:block"><path d="M7 38V14l17 15 17-15V38" stroke="${MDSITE_BRAND_COLOR}" stroke-width="6.5" stroke-linecap="round" stroke-linejoin="round"/></svg>`

export { MDSITE_FAVICON_SVG, MDSITE_FAVICON_HREF, MDSITE_FAVICON_LINK, MDSITE_BRAND_COLOR, MDSITE_LOGO_SVG }
