...
import { MDSITE_FAVICON_LINK, MDSITE_LOGO_SVG, MDSITE_BRAND_COLOR } from './brand.mjs'
...
export async function renderTemplate(file, vars) {
  ...
  return applyVars(content, {
    FAVICON: MDSITE_FAVICON_LINK,
    LOGO: MDSITE_LOGO_SVG,
    BRAND_COLOR: MDSITE_BRAND_COLOR,
    ...vars,
  })
}
